...
// 2 o (192, 105)
let point = new Point(new FieldElement(192, prime), new FieldElement(105, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`2 o (192, 105): ${point.add(point)}`);

// 2 o (143, 98)
point = new Point(new FieldElement(143, prime), new FieldElement(98, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`2 o (143, 98): ${point.add(point)}`);

// 2 o (47, 71)
point = new Point(new FieldElement(47, prime), new FieldElement(71, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`2 o (47, 71): ${point.add(point)}`);

// 4 o (47, 71)
point = new Point(new FieldElement(47, prime), new FieldElement(71, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`4 o (47, 71): ${point.add(point).add(point).add(point)}`);

// 8 o (47, 71)
point = new Point(new FieldElement(47, prime), new FieldElement(71, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`8 o (47, 71): ${point.add(point).add(point).add(point).add(point).add(point).add(point).add(point)}`);

// 21 o (47, 71)
point = new Point(new FieldElement(47, prime), new FieldElement(71, 223), new FieldElement(0, prime), new FieldElement(7, prime));
console.log(`21 o (47, 71): ${point.add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point).add(point)}`);
